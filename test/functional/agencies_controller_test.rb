...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { included_by_default: @agency.included_by_default, name: @agency.name, sort_order: @agency.sort_order }
    end
  ...
  test "should update agency" do
    put :update, id: @agency, agency: { included_by_default: @agency.included_by_default, name: @agency.name, sort_order: @agency.sort_order }
    assert_redirected_to agency_path(assigns(:agency))
  end
